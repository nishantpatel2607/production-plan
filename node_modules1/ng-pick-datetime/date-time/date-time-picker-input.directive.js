    ...
    Object.defineProperty(OwlDateTimeInputDirective.prototype, "values", {
        ...
        set: function (values) {
            ...
            if (values && values.length > 0) {
                ...
                var fromFormatted = from ? this.dateTimeAdapter.format(from, this.dtPicker.formatString) : null;
                var toFormatted = to ? this.dateTimeAdapter.format(to, this.dtPicker.formatString) : null;
